...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { instructions: @questionnaire.instructions, name: @questionnaire.name } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { instructions: @questionnaire.instructions, name: @questionnaire.name } }
