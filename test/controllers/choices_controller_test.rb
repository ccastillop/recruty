...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { body: @choice.body, question_id: @choice.question_id, score: @choice.score } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { body: @choice.body, question_id: @choice.question_id, score: @choice.score } }
